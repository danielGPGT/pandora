...
CREATE TABLE public.availability (
  ...
  CONSTRAINT availability_contract_allocation_id_fkey FOREIGN KEY (contract_allocation_id) REFERENCES public.contract_allocations(id)
);
...
CREATE TABLE public.contract_allocations (
  ...
  CONSTRAINT contract_allocations_product_option_id_fkey FOREIGN KEY (product_option_id) REFERENCES public.product_options(id)
);
